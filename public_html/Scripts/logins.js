...
function mostrarCarga(activo) {
    let bootstrapCode = '<div class="d-flex align-items-center">\
...
function mostrarAlert(tipo = "warning", mensaje) {
    let alertCode = '<div class="alert alert-' + tipo + ' alert-dismissible fade show mt-2" role="alert">' +
        mensaje + '\
